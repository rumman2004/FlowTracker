...
const AdminLogin = () => {
  ...
  const validate = () => {
    ...
    if (!form.email.trim()) {
      ...
      e.email = "Invalid email address"; ok = false;
    }
    if (!form.password) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ FIX: show the actual server message, fallback gracefully
      const msg = error?.response?.data?.message || "Invalid credentials";
      toast.error(msg);
      // ✅ FIX: clear password on failed attempt — security best practice
    ...
    <div style={{ marginBottom: "20px" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{
          ...
          color: error ? "rgba(239,68,68,0.8)" : "rgba(251,146,60,0.65)",
        ...
        <input
          ...
          onFocus={(e) => {
            e.target.style.borderColor = error
              ? "rgba(239,68,68,0.8)" : "rgba(249,115,22,0.65)";
          ...
          onBlur={(e) => {
            ...
            e.target.style.background = error
              ? "rgba(239,68,68,0.06)" : "rgba(255,255,255,0.05)";
          }}
        />
  ...
  return (
    <div style={{
      ...
      background: [
        "radial-gradient(ellipse at 20% 50%, rgba(251,146,60,0.15) 0%, transparent 55%)",
        "radial-gradient(ellipse at 80% 20%, rgba(239,68,68,0.12) 0%, transparent 55%)",
      ...
      {/* ── Decorative orbs ──────────────────────────────────────────────── */}
      {[
        { w: 600, h: 600, top: "-20%", left: "-15%", color: "rgba(251,146,60,0.12)", anim: "floatOrb1 8s ease-in-out infinite" },
        { w: 500, h: 500, bottom: "-15%", right: "-10%", color: "rgba(239,68,68,0.1)", anim: "floatOrb2 10s ease-in-out infinite" },
        { w: 300, h: 300, top: "40%", right: "20%", color: "rgba(168,85,247,0.08)", anim: "floatOrb1 12s ease-in-out infinite reverse" },
      ].map((orb, i) => (
        <div key={i} style={{
          position: "absolute",
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: loading
                  ? "none"
                  : "0 8px 28px rgba(249,115,22,0.45), inset 0 1px 0 rgba(255,255,255,0.25)",
                transition: "all 0.25s ease",
                display: "flex", alignItems: "center",
              ...
              onMouseEnter={(e) => {
                if (!loading) {
                  ...
                  e.currentTarget.style.boxShadow  =
                    "0 14px 36px rgba(249,115,22,0.55), inset 0 1px 0 rgba(255,255,255,0.25)";
                }
              }}
              onMouseLeave={(e) => {
                if (!loading) {
